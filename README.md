...
My goal was to create a chrome extension with simple functionality that provides a great user exprience.
  ...
  * I also learned how to use Chrome's tabs and storage API that can be found here: <a href src="https://developer.chrome.com/docs/extensions/reference/tabs/">Tabs API</a>, <a href src="https://developer.chrome.com/docs/extensions/reference/storage/"> Storage API</a>.
